...
# Parâmetros fixed de identidade e compliance do Gui
DADOS_GUI = {
    "nome": "Gui",
    ...
    with st.chat_message("assistant"):
        with st.spinner("O Gui está processando..."):
            ...
            if client is None:
                ...
                # --- LISTA CORRIGIDA COM OS MODELOS OFICIAIS DO SEU PAINEL CEREBRAS ---
                modelos_para_tentar = ["gemma-4-31b", "gemma4-31b", "llama3.1-8b", "llama-3.1-8b-instant"]
                bot_response = ""
